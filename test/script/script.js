...
const {BufferUtil} = pqccore.util
const {Script, Networks, Opcode, PublicKey, Address} = pqccore
...
describe('Script', () => {
  ...
  describe('#buildMultisigOut', () => {
    ...
    it('should create sorted script by default', () => {
      ...
      s.toString().should.equal('OP_2 70 0x0444000000018186f68f5d068f98ff995c49e70b5b78ec18b686f5c9519f9493f2d66034f1d39e1d77172fb4098285595194aa6a36708a56664a60e3f03b5c6db5b6353afa2d 70 0x0444000000019d730da08151aeed8c1a7eac5b699e4ee3245c8e0eef689e9b88bdfaea54ca709322e9e616b2718eaaaa3011c9dd645be7a7aac7b29e6ce67ce04ddefb19e897 70 0x044400000001e38ff92912fdacd0a03e9f8e49db95efb5196e8338c26ce8c02706f8f79e391ef08de2ecea8ec14b261526f44dea1d337aba557c2a15c6ebb783220e7f3cbca6 OP_3 OP_CHECKMULTISIG');
    ...
    it('should create unsorted script if specified', () => {
      ...
      u.toString().should.equal('OP_2 70 0x044400000001e38ff92912fdacd0a03e9f8e49db95efb5196e8338c26ce8c02706f8f79e391ef08de2ecea8ec14b261526f44dea1d337aba557c2a15c6ebb783220e7f3cbca6 70 0x0444000000019d730da08151aeed8c1a7eac5b699e4ee3245c8e0eef689e9b88bdfaea54ca709322e9e616b2718eaaaa3011c9dd645be7a7aac7b29e6ce67ce04ddefb19e897 70 0x0444000000018186f68f5d068f98ff995c49e70b5b78ec18b686f5c9519f9493f2d66034f1d39e1d77172fb4098285595194aa6a36708a56664a60e3f03b5c6db5b6353afa2d OP_3 OP_CHECKMULTISIG');
      s.isMultisigOut().should.equal(true);
    });
  ...
  describe('#buildPublicKeyHashOut', () => {
    ...
    it('should create script from public key', () => {
      ...
      should.exist(s);
      s.toString().should.equal('OP_DUP OP_HASH160 20 0x4029927f127f3536f557e73c7480e2679dc695fe OP_EQUALVERIFY OP_CHECKSIG');
      s.isPublicKeyHashOut().should.equal(true);
  ...
  describe('#buildPublicKeyOut', () => {
    it('should create script from public key', () => {
      ...
      should.exist(s);
      s.toString().should.equal('OP_PUSHDATA1 132  OP_CHECKSIG');
