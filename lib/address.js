...
export default class Address {
   ...
   *
   * The addresses will be sorted lexicographically, as that is the trend in PQCCoin.
  ...
  /**
   * Internal function to transform a PQCCoin address string
   *
   * @param {string} data
   * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
   * @param {string=} type - The type: 'pubkeyhash' or 'scripthash'
   ...
   *
   * @param {string} str - An string of address
   * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
   * @param {string=} type - The type of address: 'script' or 'pubkey'
   * @returns {Address} A new valid and frozen instance of an Address
   */
   ...
   *
   * @returns {Buffer} PQCCoin address buffer
   */
  toBuffer() {
   ...
   *
   * @returns {string} PQCCoin address
   */
  toString() {
